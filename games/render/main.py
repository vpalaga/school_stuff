...
from Faces import Vertex, HeadingTo, Face
...
"""
#scene1.models.sphere(origin=Vertex((0,200,0)),radius=150)
f1 = Face( [Vertex((-2, 2, -2)),Vertex((2, 2, -2)),Vertex((2, 2, 2)),Vertex((-2, 2, 2))], color=(100,100,100))
scene1.add_object(f1)

cam = Cam(Vertex((-3, -1, 0)), HeadingTo((45, 0)))
